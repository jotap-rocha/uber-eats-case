...
docker stop postgres-ubereats minio-ubereats minio-setup gen-unified 2>$null | Out-Null
docker rm postgres-ubereats minio-ubereats minio-setup gen-unified 2>$null | Out-Null
