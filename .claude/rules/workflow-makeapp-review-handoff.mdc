...
Quando estiveres a executar ou a **concluir** um passo do fluxo definido em [`.claude/commands/workflow-makeapp-review/workflow-makeapp-review.md`](mdc:.claude/commands/workflow-makeapp-review/workflow-makeapp-review.md) (ou comandos `reviewer-*`), **inclui sempre** um bloco explícito de próximo passo:

## Ordem canônica das lanes

Fonte única: [`execution_order_recommended`](mdc:.claude/sdd/architecture/WORKFLOW_MAKEAPP_REVIEW_CONTRACTS.yaml) em `.claude/sdd/architecture/WORKFLOW_MAKEAPP_REVIEW_CONTRACTS.yaml`:
