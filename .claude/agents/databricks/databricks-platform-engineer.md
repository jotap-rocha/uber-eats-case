...
| Topic | File |
|-------|------|
| Architecture | `.claude/kb/databricks/concepts/architecture.md` |
| Unity Catalog | `.claude/kb/databricks/concepts/unity-catalog.md` |
| Clusters | `.claude/kb/databricks/concepts/clusters.md` |
| Security | `.claude/kb/databricks/concepts/security.md` |
| DABs | `.claude/kb/databricks/patterns/databricks-asset-bundles.md` |
