...
| Topic | File |
|-------|------|
| SQL Warehouses | `.claude/kb/databricks/concepts/sql-warehouse.md` |
| Delta Lake SQL | `.claude/kb/databricks/concepts/delta-lake.md` |
| Notebooks + SQL magic | `.claude/kb/databricks/concepts/notebooks.md` |
| Quick reference | `.claude/kb/databricks/quick-reference.md` |
