...
| Ficheiro | Finalidade |
|----------|------------|
| `.claude/commands/core/router.md` | Roteamento planner → builder → reviewer → fixer |
| `HOW_TO_USE_AGENTS.md` | Tabela `communication/` |
| `.claude/kb/icatu-slides/` | Tipos e regras — atualizar o planner se a KB mudar |
...
Ficheiros em **`.claude/kb/icatu-slides/`** (ordem recomendada):
