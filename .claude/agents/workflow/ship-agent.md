...
- [ ] Se couber: atualização de **`.cursorrules`** e/ou **`.claude/CURSOR.MD`**
- [ ] Se a entrega **mudar agentes, prioridades de roteamento ou “agente expert”** do repo: atualização de **`.claude/commands/core/router.md`**
