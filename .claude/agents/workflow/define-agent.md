...
1. **Ler** `.claude/sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml`
2. **Verificar** `applies_when.signals` — se aplicável, **injetar** secção no DEFINE mesmo que o analista não peça
3. **Anexar** checklist de `.claude/sdd/templates/PIPELINE_OPS_REQUIREMENTS_APPENDIX.md`
...
**KB:** `.claude/kb/data-engineering-practices/index.md`
