...
| Necessidade | Caminho |
|-------------|---------|
| Índice | `.claude/kb/app_web_middleware/index.md` |
| Referência rápida | `.claude/kb/app_web_middleware/quick-reference.md` |
| Papel da camada | `.claude/kb/app_web_middleware/concepts/camada-middleware-aplicacao.md` |
| IIS | `.claude/kb/app_web_middleware/concepts/iis-windows.md` |
| NGINX | `.claude/kb/app_web_middleware/concepts/nginx-linux.md` |
| Apache | `.claude/kb/app_web_middleware/concepts/apache-httpd-linux.md` |
| Proxy genérico | `.claude/kb/app_web_middleware/patterns/reverse-proxy-upstream.md` |
| Hardening | `.claude/kb/app_web_middleware/patterns/hardening-borda-checklist.md` |
| Few-shot IIS | `.claude/kb/app_web_middleware/patterns/few-shot-iis-web-config-url-rewrite.md` |
| Few-shot NGINX | `.claude/kb/app_web_middleware/patterns/few-shot-nginx-sites-available.md` |
| WebSockets NGINX (`map` + `Upgrade`) | `.claude/kb/app_web_middleware/patterns/nginx-websocket-proxy-map.md` |
| Few-shot Apache | `.claude/kb/app_web_middleware/patterns/few-shot-apache-sites-available.md` |
| Checklist YAML | `.claude/kb/app_web_middleware/specs/borda-web-checklist.yaml` |

**Complemento segurança (cabeçalhos, APIs, release):** `.claude/kb/app_security/` — não duplicar política de app aqui.
