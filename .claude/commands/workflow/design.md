...
Read(.claude/sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml)  # se pipeline de dados
Read(.claude/sdd/templates/PIPELINE_OPS_DESIGN_APPENDIX.md)       # se pipeline de dados
Glob(.claude/skills/*/SKILL.md)  # Skills disponíveis — ver .claude/rules/skill-first.md antes de propor KB novo
