...
**Canônico:** `.claude/commands/workflow-data-pipeline-review/pipeline-review-lane.md`.
...
- Relatório completo em `.claude/sdd/data-pipeline-reviews/{RUN_ID}/lanes/{lane_id}.md`.
...
Detalhe do processo: `.claude/agents/workflow-data-pipeline-review/data-pipeline-review-lane.md`.
