...
description: |
  Inicia execução Data Pipeline Review: cria RUN em .claude/sdd/data-pipeline-reviews/{RUN_ID}/
...
**Canônico:** `.claude/commands/workflow-data-pipeline-review/pipeline-review-init.md`.
...
1. Cria `.claude/sdd/data-pipeline-reviews/{RUN_ID}/`.
...
Invocar **`data-pipeline-review-init`** (`.claude/agents/workflow-data-pipeline-review/data-pipeline-review-init.md`).
...
Contrato de lanes: `.claude/sdd/architecture/WORKFLOW_DATA_PIPELINE_REVIEW_CONTRACTS.yaml`  
Documentação: `.claude/sdd/data-pipeline-reviews/README.md`
