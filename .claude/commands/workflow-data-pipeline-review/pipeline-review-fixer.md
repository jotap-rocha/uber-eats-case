...
**Canônico:** `.claude/commands/workflow-data-pipeline-review/pipeline-review-fixer.md`.
...
**`data-pipeline-review-fixer`** — `.claude/agents/workflow-data-pipeline-review/data-pipeline-review-fixer.md`
