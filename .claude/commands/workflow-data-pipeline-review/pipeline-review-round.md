...
**Canônico:** `.claude/commands/workflow-data-pipeline-review/pipeline-review-round.md`.
...
1. Lê `.claude/sdd/data-pipeline-reviews/{RUN_ID}/REVIEW_MANIFEST.yaml`.
...
**`data-pipeline-review-round`** — `.claude/agents/workflow-data-pipeline-review/data-pipeline-review-round.md`
