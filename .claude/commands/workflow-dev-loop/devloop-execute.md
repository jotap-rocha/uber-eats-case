...
**Canônico:** `.claude/commands/workflow-dev-loop/devloop-execute.md`
...
1. Lê manifest → `prompt_file` (ex.: `.claude/dev/tasks/PROMPT_{RUN_ID}.md`)
...
**`devloop-execute`** — `.claude/agents/workflow-dev-loop/devloop-execute.md`  
Motor: `dev-loop-executor` + [`.claude/commands/dev/dev.md`](../dev/dev.md)
