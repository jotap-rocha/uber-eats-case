...
**Canónico:** `.claude/commands/workflow-makeapp-review/reviewer-lane.md`. Atalho: [`../review/reviewer-lane.md`](../review/reviewer-lane.md).
...
- Relatório **completo** em `.claude/sdd/reviews/{RUN_ID}/lanes/{lane_id}.md`
...
Detalhe do processo: `.claude/agents/workflow-makeapp-review/makeapp-review-lane.md`.

---

## Agente

**`makeapp-review-lane`** — `.claude/agents/workflow-makeapp-review/makeapp-review-lane.md`

---

## Referências

- Lanes, globs, KB: `.claude/sdd/architecture/WORKFLOW_MAKEAPP_REVIEW_CONTRACTS.yaml`
- Estado: `.claude/sdd/reviews/{RUN_ID}/REVIEW_MANIFEST.yaml`
- Sumário consolidado (após `ui_ux`): `.claude/sdd/reviews/{RUN_ID}/REVIEW_SUMMARY.md`
