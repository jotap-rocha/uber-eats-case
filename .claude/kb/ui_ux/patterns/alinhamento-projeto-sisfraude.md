...
- `.claude/kb/sisfraude/` — domínio de casos e sessão multi-empresa  
- `.claude/kb/frontend/` — Tailwind, shadcn, TypeScript  
- `.claude/kb/react/` — hooks, estado derivado, providers  
