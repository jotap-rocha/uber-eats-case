# Protobuf — PySpark 4.0.1 documentation
*   [](../../index.html)
...
* from_protobuf(data, messageName[, ...]): to_protobuf(data, messageName[, ...])
  * Converts a binary column of Protobuf format into its corresponding catalyst value.: Converts a column into binary of protobuf format.


# pyspark.sql.protobuf.functions.from_protobuf — PySpark 4.0.1 documentation
pyspark.sql.protobuf.functions.from\_protobuf(_data_, _messageName_, _descFilePath\=None_, _options\=None_, _binaryDescriptorSet\=None_)
[\[source\]](about:blank/_modules/pyspark/sql/protobuf/functions.html#from_protobuf)
[#](#pyspark.sql.protobuf.functions.from_protobuf "Permalink to this definition")
...
>     
>     protoc –include\_imports –descriptor\_set\_out=abc.desc abc.proto
>     
...
>     
> *   Jar containing Protobuf Java class: The jar containing Java class should be shaded. Specifically, com.google.protobuf.\* should be shaded to org.sparkproject.spark\_protobuf.protobuf.\*. [rangadi/shaded-protobuf-classes](https://github.com/rangadi/shaded-protobuf-classes) is useful to create shaded jar from Protobuf files. The jar file can be added with spark-submit option –jars.
>     
...
# pyspark.sql.protobuf.functions.to_protobuf — PySpark 4.0.1 documentation
pyspark.sql.protobuf.functions.to\_protobuf(_data_, _messageName_, _descFilePath\=None_, _options\=None_, _binaryDescriptorSet\=None_)
[\[source\]](about:blank/_modules/pyspark/sql/protobuf/functions.html#to_protobuf)
[#](#pyspark.sql.protobuf.functions.to_protobuf "Permalink to this definition")
