...
| Topic | File |
|-------|------|
| **Quick Start** | `.claude/kb/spark/01-quick-start/quick-start.md` |
| **DataFrames** | `.claude/kb/spark/03-sql-dataframes-datasets/sql-dataframes-datasets.md` |
| **PySpark Quickstart** | `.claude/kb/spark/06-pyspark-quickstart/01-quickstart-dataframe.md` |
| **Structured Streaming** | `.claude/kb/spark/04-structured-streaming/img/structuredstreaming.md` |
| **SparkSQL** | `.claude/kb/spark/07-spark-sql/` |
| **Window Functions** | `.claude/kb/spark/10-spark-api-reference/10-sql-sql-spark-window.md` |
| **Resource Management** | `.claude/kb/spark/13-spark-resource-management/01-spark-resource-management.md` |
| **Error Handling** | `.claude/kb/spark/14-spark-errors/01-spark-errors.md` |
| **Logging** | `.claude/kb/spark/15-spark-logger/01-spark-logger.md` |
| **Testing** | `.claude/kb/spark/16-spark-testing/01-spark-testing.md` |
| **User Guide** | `.claude/kb/spark/09-spark-user-guide/chapter01-dataframes.md` |
| **Full Index** | `.claude/kb/spark/index.md` |
...
**For detailed information, see the full documentation in `.claude/kb/spark/`**
