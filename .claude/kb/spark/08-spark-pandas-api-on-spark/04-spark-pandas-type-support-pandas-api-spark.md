# Type Support in Pandas API on Spark — PySpark 4.0.1 documentation
...
Type casting between PySpark and pandas API on Spark[#](#type-casting-between-pyspark-and-pandas-api-on-spark "Permalink to this headline")
-------------------------------------------------------------------------------------------------------------------------------------------
...
Type casting between pandas and pandas API on Spark[#](#type-casting-between-pandas-and-pandas-api-on-spark "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------------------------
...
Internal type mapping[#](#internal-type-mapping "Permalink to this headline")
-----------------------------------------------------------------------------
...
You can check this mapping by using the as\_spark\_type function.
