# FAQ — PySpark 4.0.1 documentation
Should I use PySpark’s DataFrame API or pandas API on Spark?[#](#should-i-use-pyspark-s-dataframe-api-or-pandas-api-on-spark "Permalink to this headline")
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
Does pandas API on Spark support Structured Streaming?[#](#does-pandas-api-on-spark-support-structured-streaming "Permalink to this headline")
----------------------------------------------------------------------------------------------------------------------------------------------
...
How is pandas API on Spark different from Dask?[#](#how-is-pandas-api-on-spark-different-from-dask "Permalink to this headline")
--------------------------------------------------------------------------------------------------------------------------------
