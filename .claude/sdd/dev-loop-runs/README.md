...
PROMPT executável: `.claude/dev/tasks/PROMPT_{RUN_ID}.md` (referenciado no manifest).

## Comandos Cursor

Canônico: `.claude/commands/workflow-dev-loop/workflow-dev-loop.md`
...
Contrato: [`.claude/sdd/architecture/WORKFLOW_DEV_LOOP_CONTRACTS.yaml`](../architecture/WORKFLOW_DEV_LOOP_CONTRACTS.yaml)
