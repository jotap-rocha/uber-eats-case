...
PROMPT executável: `.github/dev/tasks/PROMPT_{RUN_ID}.md` (referenciado no manifest).

## Comandos Cursor

Canônico: `.github/commands/workflow-dev-loop/workflow-dev-loop.md`
...
Contrato: [`.github/sdd/architecture/WORKFLOW_DEV_LOOP_CONTRACTS.yaml`](../architecture/WORKFLOW_DEV_LOOP_CONTRACTS.yaml)
