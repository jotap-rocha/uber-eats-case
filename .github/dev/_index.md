...
Ver [`.github/commands/workflow-dev-loop/`](../commands/workflow-dev-loop/) e [`DEV_LOOP_Guia_Comandos.md`](../../get_started/DEV_LOOP_Guia_Comandos.md).
...
```bash
# Copy template
cp .github/dev/templates/PROMPT_TEMPLATE.md \
   .github/dev/tasks/PROMPT_MY_TASK.md
...
See `.github/dev/docs/AGENT_MATCHING_ENGINE.md` for full algorithm.
...
| File | Purpose |
|------|---------|
| `.github/commands/dev/dev.md` | Command definition |
| `.github/agents/dev/prompt-crafter.md` | PROMPT crafting agent |
| `.github/agents/dev/agentloop-executor.md` | Execution agent |
| `.github/dev/docs/AGENT_MATCHING_ENGINE.md` | Matching Engine algorithm |
| `.github/dev/templates/PROMPT_TEMPLATE.md` | Blank PROMPT template |
| `.github/dev/templates/PROMPT_EXAMPLE_FEATURE.md` | Example: Python utility |
| `.github/dev/templates/PROMPT_EXAMPLE_KB.md` | Example: KB domain |
| `.github/dev/templates/PROGRESS_TEMPLATE.md` | Progress file template |
| `.github/dev/examples/` | Real-world examples from actual feature builds |
