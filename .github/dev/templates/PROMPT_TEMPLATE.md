...
Use caminhos completos: @.github/agents/<domínio>/<agente>.md — ver HOW_TO_USE_AGENTS.md.
...
|---------------------|----------------|---------|
| [ex.: planejamento / ADR] | the-planner | `@.github/agents/communication/the-planner.md` |
| [ex.: implementação domínio] | (preencher) | `@.github/agents/...` |
...
Prefix with @.github/agents/.../file.md quando for delegação explícita ao executor
...
- [ ] `@.github/agents/...` — [Architectural or integration task]

### 🟡 CORE
<!-- Main feature implementation -->

- [ ] `@.github/agents/...` — [Main feature task]
- [ ] [Task with verification]: Verify: `python3 scripts/validate-agent-router.py`

### 🟢 POLISH (Do Last)
<!-- Cleanup, optimization, nice-to-haves -->

- [ ] `@.github/agents/code-quality/code-reviewer.md` — [Revisão final, se aplicável]
...
- [Related PRD or Spec](.github/sdd/features/PRD_*.md)
