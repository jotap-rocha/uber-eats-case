...
Quando estiveres a executar ou a **concluir** um passo do fluxo definido em [`.github/commands/workflow-data-pipeline-review/workflow-data-pipeline-review.md`](mdc:.github/commands/workflow-data-pipeline-review/workflow-data-pipeline-review.md) (ou comandos `pipeline-review-*`), **inclui sempre** um bloco explícito de próximo passo.

## Ordem canônica das lanes

Fonte única: [`execution_order_recommended`](mdc:.github/sdd/architecture/WORKFLOW_DATA_PIPELINE_REVIEW_CONTRACTS.yaml) em `.github/sdd/architecture/WORKFLOW_DATA_PIPELINE_REVIEW_CONTRACTS.yaml`:
