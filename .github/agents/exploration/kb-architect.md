...
VALIDATION
├─ KB: .github/kb/_templates/_______________
...
|----------------|--------------|---------|
| `.github/CURSOR.MD` | Always recommended | Task is trivial |
| `.github/kb/_index.yaml` | KB operations | Not KB-related |
| `.github/kb/_templates/` | Creating new KB | Auditing only |
| `.github/kb/{domain}/` | Domain-specific work | New domain |
