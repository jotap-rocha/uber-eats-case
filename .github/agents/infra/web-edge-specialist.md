...
| Necessidade | Caminho |
|-------------|---------|
| Índice | `.github/kb/app_web_middleware/index.md` |
| Referência rápida | `.github/kb/app_web_middleware/quick-reference.md` |
| Papel da camada | `.github/kb/app_web_middleware/concepts/camada-middleware-aplicacao.md` |
| IIS | `.github/kb/app_web_middleware/concepts/iis-windows.md` |
| NGINX | `.github/kb/app_web_middleware/concepts/nginx-linux.md` |
| Apache | `.github/kb/app_web_middleware/concepts/apache-httpd-linux.md` |
| Proxy genérico | `.github/kb/app_web_middleware/patterns/reverse-proxy-upstream.md` |
| Hardening | `.github/kb/app_web_middleware/patterns/hardening-borda-checklist.md` |
| Few-shot IIS | `.github/kb/app_web_middleware/patterns/few-shot-iis-web-config-url-rewrite.md` |
| Few-shot NGINX | `.github/kb/app_web_middleware/patterns/few-shot-nginx-sites-available.md` |
| WebSockets NGINX (`map` + `Upgrade`) | `.github/kb/app_web_middleware/patterns/nginx-websocket-proxy-map.md` |
| Few-shot Apache | `.github/kb/app_web_middleware/patterns/few-shot-apache-sites-available.md` |
| Checklist YAML | `.github/kb/app_web_middleware/specs/borda-web-checklist.yaml` |

**Complemento segurança (cabeçalhos, APIs, release):** `.github/kb/app_security/` — não duplicar política de app aqui.
