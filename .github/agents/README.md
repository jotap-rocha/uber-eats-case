...
Índice dos agentes em `.github/agents/`. Este diretório é parte do template agentic/SDD.
...
| Agente | Ficheiro | Finalidade (resumo) |
|--------|----------|---------------------|
| `agent-architect` | [`exploration/agent-architect.md`](exploration/agent-architect.md) | Especialista em projetar e implementar novos arquivos de agente Cursor (Markdown em `.github/agents/`). Use PROATIVAM… |
...
| `makeapp-review-init` | [`workflow-makeapp-review/makeapp-review-init.md`](workflow-makeapp-review/makeapp-review-init.md) | Inicia uma execução MakeApp Review: cria RUN_ID, REVIEW_MANIFEST.yaml e stubs lanes/ sob .github/sdd/reviews/{RUN_I… |
