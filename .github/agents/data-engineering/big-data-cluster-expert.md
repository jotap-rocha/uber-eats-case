...
| `.github/commands/core/router.md` | Roteamento de agentes |
| `.github/kb/migration-hub/` | Fonte narrativa do ambiente e da migração |
...
**KB:** `.github/kb/migration-hub/spark/PADRAO-SPARK-SUBMIT-PROJETO-PRD.md`  
**Layout:** `.github/kb/design-pipelines-patterns/patterns/spark-submit-yarn-config.md`
...
Registo canónico do domínio: `.github/kb/_index.yaml` → `domains.migration-hub`.

| Prioridade | Caminho | Uso |
|------------|---------|-----|
| 1 | `.github/kb/migration-hub/index.md` | Índice e ordem de leitura |
| 2 | `.github/kb/migration-hub/planning.md` | Fases, roadmap migração |
| 3 | `.github/kb/migration-hub/migration/index.md` | Domínio migração |
| 4 | `.github/kb/migration-hub/naming_conventions.md` | Identidades Airflow, paths |
| 5 | `.github/kb/migration-hub/infra/STATUS-AMBIENTE.md` | Estado das máquinas |
| 6 | `.github/kb/migration-hub/infra/ssh_configuration.md` | Malha SSH **311/314**, `rsync` |
| 7 | `.github/kb/migration-hub/architecture.md`, `cluster_topology.md`, `inventory.md` | Desenho e inventário |
| 8 | `.github/kb/migration-hub/team.md` | Equipa / responsabilidades (quando aplicável) |
| 9 | `/DATALAKE/workspace/jp/platform/scripts/infra/validate_cluster.sh` | Validação em lote (311, utilizador `hadoop`) |

**Ponte curta:** `.github/kb/migration/index.md` (lista de links).

**Spark — execução em projetos PRD:**

- `.github/kb/migration-hub/spark/PADRAO-SPARK-SUBMIT-PROJETO-PRD.md` — **padrão obrigatório** `config/spark.conf`
- `.github/kb/migration-hub/spark/01-spark-3.5.2.md`, `CHECKLIST-BOAS-PRATICAS.md`

**KB técnica complementar:**

- `.github/kb/spark/` — PySpark, APIs, referências longas.
- `.github/kb/design-pipelines-patterns/` — árvore de pastas + `patterns/spark-submit-yarn-config.md`
- `.github/kb/dev-python-engineering/` — Python dados, performance.
...
1. Abrir `.github/kb/migration-hub/index.md` e seguir a tabela “Por onde começar”.
...
3. Mencionar firewall/portas quando propor novos serviços (alinhado a `.githubrules`).
...
4. Para mudanças que alterem ambiente real: lembrar atualização de `inventory.md` / `architecture.md` / `planning.md` conforme `.githubrules`.
...
- **kb-architect:** estruturação de novos domínios em `.github/kb/`, não troubleshooting de cluster.
