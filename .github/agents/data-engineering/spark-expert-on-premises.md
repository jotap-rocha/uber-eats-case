...
- Roteamento: `.github/commands/core/router.md`
- KB Spark genérica: `.github/kb/spark/`; padrões de pipeline SQL (exemplos): `.github/kb/sql-capacity/` (processo, não inventário de hosts)
...
- Regras de **negócio do produto** e runbooks: agente expert em `.github/commands/core/router.md`, se cadastrado.
