...
VALIDAÇÃO
├─ KB: .github/kb/{domínio}/_______________
...
|-------------------|-----------------|----------|
| `.github/CURSOR.MD` | Sempre recomendado | Tarefa trivial |
| `.github/kb/{domínio}/` | Tarefa combina com domínio | Domínio não aplicável |
...
**Processo:**
1. Carregar KB: `.github/kb/{domínio}/{arquivo}.md`
...
| Novo domínio KB | Criar `.github/kb/{domínio}/` |
