...
Atualizar `router.md`, `.github/CURSOR.MD` e KB quando o padrão **spark-submit** ou roteamento de agentes mudar.
...
| Caminho | Uso |
|---------|-----|
| `.github/kb/migration-hub/index.md` | Ordem de leitura cluster |
| `.github/kb/migration-hub/spark/PADRAO-SPARK-SUBMIT-PROJETO-PRD.md` | **Padrão obrigatório** spark-submit |
| `.github/kb/migration-hub/spark/01-spark-3.5.2.md` | Spark 3.5.2 on YARN |
| `.github/kb/migration-hub/spark/CHECKLIST-BOAS-PRATICAS.md` | Smoke e boas práticas |
| `.github/agents/data-engineering/big-data-cluster-expert.md` | Âncora operacional cluster |

### Layout e código

| Caminho | Uso |
|---------|-----|
| `.github/kb/design-pipelines-patterns/index.md` | Árvore `etl/`, `pipelines/`, `config/` |
| `.github/kb/design-pipelines-patterns/patterns/spark-submit-yarn-config.md` | Onde guardar `spark.conf` |
| `.github/kb/design-pipelines-patterns/specs/project-layout-mandatory.yaml` | Layout máquina-legível |

### Referência técnica Spark

| Caminho | Uso |
|---------|-----|
| `.github/kb/spark/index.md` | Índice APIs e guias |
| `.github/kb/spark/quick-reference.md` | Consulta rápida |

Registo KB: `.github/kb/_index.yaml` → `migration-hub`, `design-pipelines-patterns`, domínio `spark/` (pasta).
