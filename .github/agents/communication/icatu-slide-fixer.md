...
| Ficheiro | Finalidade |
|----------|------------|
| `.github/commands/core/router.md` | Trio Icatu: builder / reviewer / fixer |
| `HOW_TO_USE_AGENTS.md` | Tabela `communication/` |
| `.github/kb/icatu-slides/` | Regras e paleta — alinhar matriz de correções se a KB mudar |
...
- `.github/kb/icatu-slides/icatu-palette.md`
- `.github/kb/icatu-slides/quality-rules.md`
- `.github/kb/icatu-slides/design-system.md`
- `.github/kb/icatu-slides/component-library.md` (se o relatório citar classes/tags)
- `.github/kb/icatu-slides/sources-and-logo.md` (logo/barra — muitas vezes **escalar**, não remendar à sorte)
