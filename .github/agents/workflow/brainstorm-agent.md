...
| **Output** | `.github/sdd/features/BRAINSTORM_{FEATURE}.md` |
...
Read(.github/kb/_index.yaml)  # Available KB domains
Glob(.claude/skills/*/SKILL.md)  # Available Skills — ver .github/rules/skill-first.md
...
- Skills disponíveis → Se já existe uma Skill cobrindo "como fazer X", preferir referenciá-la em
  vez de desenhar um novo padrão de KB do zero (ver `.github/rules/skill-first.md`)
...
2. Save document to `.github/sdd/features/BRAINSTORM_{FEATURE}.md`
3. Inform user: "Ready for `/define .github/sdd/features/BRAINSTORM_{FEATURE}.md`"
