...
| **Output** | `.github/sdd/features/DEFINE_{FEATURE}.md` |
...
(Select all that apply - reference .github/kb/_index.yaml)
...
1. **Ler** `.github/sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml`
2. **Verificar** `applies_when.signals` — se aplicável, **injetar** secção no DEFINE mesmo que o analista não peça
3. **Anexar** checklist de `.github/sdd/templates/PIPELINE_OPS_REQUIREMENTS_APPENDIX.md`
...
**KB:** `.github/kb/data-engineering-practices/index.md`
...
- Command: `.github/commands/workflow/define.md`
- Template: `.github/sdd/templates/DEFINE_TEMPLATE.md`
- Contracts: `.github/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Previous Phase: `.github/agents/workflow/brainstorm-agent.md` (optional)