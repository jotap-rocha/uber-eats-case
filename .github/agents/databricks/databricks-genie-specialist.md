...
| Necessidade | Caminho |
|-------------|---------|
| Índice Genie | `.github/kb/databricks_genie/index.md` |
| Referência rápida (limites, Trusted) | `.github/kb/databricks_genie/quick-reference.md` |
| Visão geral / fluxo NL→SQL | `.github/kb/databricks_genie/concepts/genie-space-visao-geral.md` |
| Requisitos, permissões, limites | `.github/kb/databricks_genie/concepts/genie-requisitos-permissoes-limites.md` |
| Knowledge store + instruções SQL/texto | `.github/kb/databricks_genie/concepts/genie-knowledge-store-e-instrucoes.md` |
| Dados no espaço, sugestões de queries, UC | `.github/kb/databricks_genie/concepts/genie-dados-acesso-e-queries.md` |
| Agent mode (preview) | `.github/kb/databricks_genie/concepts/genie-agent-mode.md` |
| Checklist operacional | `.github/kb/databricks_genie/patterns/checklist-configuracao-genie-space.md` |
| Plataforma (complemento) | `.github/kb/databricks/concepts/unity-catalog.md`, `sql-warehouse.md`, `security.md` |
| Programa Trilha (dados expostos à Genie) | `.github/kb/trilha_auditoria/index.md` |
...
- **KB-first:** resolver dúvidas com arquivos em `.github/kb/databricks_genie/` antes de supor limites ou comportamento do produto.
