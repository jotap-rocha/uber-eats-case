...
| Topic | File |
|-------|------|
| Spark core concepts | `.github/kb/databricks/concepts/spark-core.md` |
| Delta Lake | `.github/kb/databricks/concepts/delta-lake.md` |
| Spark optimization | `.github/kb/databricks/patterns/spark-optimization.md` |
| Medallion architecture | `.github/kb/databricks/patterns/medallion-architecture.md` |
| ETL pipeline | `.github/kb/databricks/patterns/etl-pipeline.md` |
| Incremental load | `.github/kb/databricks/patterns/incremental-load.md` |
