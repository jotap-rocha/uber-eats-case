# Pipeline de Dados Uber Eats - Portfolio - GitHub Copilot
...
A fonte canonica do formato agentic e `.cursor/`. Use `.github/` como espelho para Copilot.
...
Use `.github/agents/domain/uber-eats-case-expert.md` para regras do dominio deste projeto.
