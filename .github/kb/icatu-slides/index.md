...
4. Arquivos desta pasta `.github/kb/icatu-slides/`.
...
- **Planear (sem HTML):** `@.github/agents/communication/icatu-slide-planner.md` — slide-map com tipos `slide--icatu-*`, chunks e layout alinhados ao PDF.
- **Gerar:** `@.github/agents/communication/icatu-slide-builder.md` + KB **`@.github/kb/icatu-slides/`** (ou `index.md`).
- **Rever (read-only):** `@.github/agents/communication/icatu-slide-reviewer.md` no ficheiro HTML — valida paleta, marca, motor e checklist frente aos PDFs em `templates/ppts/ICATU/`.
- **Corrigir (mecânico):** `@.github/agents/communication/icatu-slide-fixer.md` com base no relatório do revisor (diff mínimo); reestruturação → builder.
