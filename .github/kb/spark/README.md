...
grep -r "window function" .github/kb/spark/
grep -r "adaptive query execution" .github/kb/spark/
```

### 3. Use the Agent

The Spark expert agent at `.github/agents/spark-expert.md` provides:
...
Search: grep -r "adaptive query execution" .github/kb/spark/
```

### 5. Troubleshooting

```
Search: grep -r "error message" .github/kb/spark/
