...
Esta KB é consultada quando perguntas envolvem **pipelines SQL**, jobs, execução e troubleshooting deste domínio; o agente primário é definido pelo roteador em `.github/commands/core/router.md`.

### Buscar na KB

```bash
grep -r "termo" .github/kb/sql-capacity/
```
