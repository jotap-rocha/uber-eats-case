...
- Mandatos: `.github/sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml` → categoria `pyodbc_sqlserver`
- Template decisão: `.github/sdd/templates/PYODBC_WRITE_MODE_GATE.md`
