...
- KB SQL Capacity (domínio): `.github/kb/sql-capacity-prd/patterns/ssl-java-configuration.md`
- Guia rápido repo: `docs/ssl-troubleshooting-quick-guide.md`
- Código: `src/utils/pyodbc_sqlserver.py`
- Agente migração: `@.github/agents/data-engineering/spark-cluster-migration-expert.md`
