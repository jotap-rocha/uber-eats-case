...
This knowledge base provides expert-level documentation for developing, configuring, and operating Lakeflow pipelines. It's designed to work with Cursor Code's MCP capabilities for zero-error, production-ready guidance.
...
grep -r "AUTO CDC" .github/kb/lakeflow/
grep -r "expect_or_drop" .github/kb/lakeflow/
grep -r "serverless" .github/kb/lakeflow/
```

### 3. Use the Agent

The Lakeflow expert agent at `.github/agents/lakeflow-expert.md` provides:
...
```
Search: grep -r "error message" .github/kb/lakeflow/
...
- [Agent Configuration](../.github/agents/lakeflow-expert.md)
