...
name: reviewer-init
description: |
  Inicia execução MakeApp Review: cria RUN em .github/sdd/reviews/{RUN_ID}/ com manifest
...
**Canónico:** `.github/commands/workflow-makeapp-review/reviewer-init.md`. Atalho: [`../review/reviewer-init.md`](../review/reviewer-init.md) (mesmo `name` no frontmatter).
...
1. Cria `.github/sdd/reviews/{RUN_ID}/`
...
Invocar **`makeapp-review-init`** (`.github/agents/workflow-makeapp-review/makeapp-review-init.md`).
...
Contrato de lanes: `.github/sdd/architecture/WORKFLOW_MAKEAPP_REVIEW_CONTRACTS.yaml`  
Documentação: `.github/sdd/reviews/README.md`
