...
/define .github/sdd/features/BRAINSTORM_INVOICE_PROCESSING.md
...
Phase 1: /define     → .github/sdd/features/DEFINE_{FEATURE}.md (THIS COMMAND)
...
```markdown
Write(.github/sdd/features/DEFINE_{FEATURE_NAME}.md)
```
...
- Previous Phase: `.github/commands/workflow/brainstorm.md` (optional)
- Next Phase: `.github/commands/workflow/design.md`