...
```text
Phase 0: /brainstorm → .github/sdd/features/BRAINSTORM_{FEATURE}.md (THIS COMMAND)
...
```markdown
Write(.github/sdd/features/BRAINSTORM_{FEATURE}.md)
```
...
**Next Step:** `/define .github/sdd/features/BRAINSTORM_{FEATURE}.md`
...
- Next Phase: `.github/commands/workflow/define.md`