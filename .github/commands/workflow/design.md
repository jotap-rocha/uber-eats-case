...
```bash
/design .github/sdd/features/DEFINE_CLOUD_RUN_FUNCTIONS.md
/design DEFINE_USER_AUTH.md
/design .github/sdd/features/DEFINE_INVOICE_EXTRACTION.md
```
...
Read(.github/sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml)  # se pipeline de dados
Read(.github/sdd/templates/PIPELINE_OPS_DESIGN_APPENDIX.md)       # se pipeline de dados
Glob(.claude/skills/*/SKILL.md)  # Skills disponíveis — ver .github/rules/skill-first.md antes de propor KB novo
...
- Next Phase: `.github/commands/workflow/build.md`