...
✅ PROMPT CREATED
=================
File: .github/dev/tasks/PROMPT_REDIS_CACHE.md
Tasks: 6 (🔴2 🟡3 🟢1)
...
# Progress was saved to: .github/dev/progress/PROGRESS_REDIS_CACHE.md
...
| Resource | Path |
|----------|------|
| Level 2 Overview | `.github/dev/_index.md` |
| Prompt Crafter Agent | `.github/agents/dev/prompt-crafter.md` |
| Dev Loop Executor | `.github/agents/dev/dev-loop-executor.md` |
| PROMPT Template | `.github/dev/templates/PROMPT_TEMPLATE.md` |
| Level 3 (SDD) | `.github/sdd/_index.md` |
