...
name: sync-agents
description: |
  Mantém o índice local de agentes em `.github/agents/README.md` alinhado com os
...
# Sync Agents — índice `.github/agents/README.md`

Garante que a seção **«Índice local (este repositório)»** em `.github/agents/README.md` reflete todos os agentes presentes em `.github/agents/**/*.md`, com **Total: N agentes** correto e uma linha por agente (link + finalidade).
...
| Entrada | Regra |
|---------|--------|
| Ficheiros contados | `.github/agents/**/*.md` |
...
Ou no Cursor: `Glob(".github/agents/**/*.md")` e filtrar mentalmente `README` e `_template`.

### 2. Actualizar o README

1. Abrir `.github/agents/README.md`.
...
```text
/sync-agents — lista todos os .md em .github/agents exceto README e _template;
...
- Links no README: relativos ao directório `.github/agents/` (ex.: `[nome](data-engineering/nome.md)`).
