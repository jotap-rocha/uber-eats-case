...
1. **Reads session data** from `.github/telemetry/sessions/`
2. **Computes aggregates** (phase timing, agent effectiveness, trends)
3. **Generates reports** in `.github/telemetry/reports/`
...
- `.github/sdd/archive/*/` - Shipped feature artifacts
- `.github/telemetry/sessions/` - Session JSON files
...
3. Save session JSON to `.github/telemetry/sessions/`
4. Update aggregates
...
- Delete anytime: `rm -rf .github/telemetry/`