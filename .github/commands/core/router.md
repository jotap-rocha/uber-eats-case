...
5. instruir a abertura do arquivo do agente primário em `.github/agents/`
...
### Atualizar **este** arquivo (`.github/commands/core/router.md`)
...
| `.github/CURSOR.MD` | Contexto ampliado do repositório |
| `CONTEXT.md` | Onboarding rápido na raiz |

**Definition of Done (processo do time):** toda entrega que mude **como o projeto é executado, navegado ou depurado** deve ir acompanhada de PR (ou commit na mesma entrega) atualizando pelo menos **`CONTEXT.md`** e, quando fizer sentido, **`.cursorrules`** e **`.github/CURSOR.MD`**; se a mudança afetar **cadastro de agentes ou prioridades de roteamento**, atualize também **este `router.md`**. O objetivo é que humanos e assistente permaneçam alinhados ao repositório real, sem depender só dos lembretes nos arquivos dos agentes.
...
1. abrir o arquivo markdown do agente primário dentro de `.github/agents/`
2. usar esse arquivo como instrução principal de comportamento, escopo e estilo
3. consultar a knowledge base relevante em `.github/kb/` quando aplicável
...
| Campo | Valor |
|-------|--------|
| **Arquivo** | `.github/agents/<pasta>/<nome>-expert.md` |
...
### AI/ML
- `.github/agents/ai-ml/ai-data-engineer.md`
- `.github/agents/ai-ml/ai-prompt-specialist.md`
- `.github/agents/ai-ml/genai-architect.md`
- `.github/agents/ai-ml/crewai-builder.md`
- `.github/agents/ai-ml/llm-specialist.md`

### Code quality
- `.github/agents/code-quality/code-cleaner.md`
- `.github/agents/code-quality/code-documenter.md`
- `.github/agents/code-quality/code-reviewer.md`
- `.github/agents/code-quality/dual-reviewer.md`
- `.github/agents/code-quality/python-developer.md`
- `.github/agents/code-quality/test-generator.md`

### Communication
- `.github/agents/communication/adaptive-explainer.md`
- `.github/agents/communication/metting-analyst.md`
- `.github/agents/communication/the-planner.md`

- `.github/agents/communication/aide-slide-builder.md`
- `.github/agents/communication/aide-slide-fixer.md`
- `.github/agents/communication/aide-slide-planner.md`
- `.github/agents/communication/aide-slide-reviewer.md`
- `.github/agents/communication/icatu-slide-planner.md`
- `.github/agents/communication/icatu-slide-builder.md`
- `.github/agents/communication/icatu-slide-reviewer.md`
- `.github/agents/communication/icatu-slide-fixer.md`

### Data engineering
- `.github/agents/data-engineering/lakeflow-architect.md`
- `.github/agents/data-engineering/lakeflow-expert.md`
- `.github/agents/data-engineering/lakeflow-pipeline-builder.md`
- `.github/agents/data-engineering/medallion-architect.md`
- `.github/agents/data-engineering/spark-expert.md`
- `.github/agents/data-engineering/spark-expert-on-premises.md`
- `.github/agents/data-engineering/spark-performance-analyzer.md`
- `.github/agents/data-engineering/spark-specialist.md`
- `.github/agents/data-engineering/spark-streaming-architect.md`
- `.github/agents/data-engineering/spark-troubleshooter.md`

### Dev
- `.github/agents/dev/dev-loop-executor.md`
- `.github/agents/dev/prompt-crafter.md`

### Domain
- `.github/agents/domain/dataops-builder.md`
- `.github/agents/domain/extraction-specialist.md`
- `.github/agents/domain/function-developer.md`
- `.github/agents/domain/infra-deployer.md`
- `.github/agents/domain/pipeline-architect.md`
- `.github/agents/domain/sql-capacity-expert.md`
- `.github/agents/domain/key-oci-expert.md`
- `.github/agents/domain/teams-notifications-expert.md`

### Exploration
- `.github/agents/exploration/agent-architect.md`
- `.github/agents/exploration/codebase-explorer.md`
- `.github/agents/exploration/kb-architect.md`

### Workflow
- `.github/agents/workflow/brainstorm-agent.md`
- `.github/agents/workflow/build-agent.md`
- `.github/agents/workflow/define-agent.md`
- `.github/agents/workflow/design-agent.md`
- `.github/agents/workflow/iterate-agent.md`
...
Referência: `.github/commands/workflow-data-pipeline-review/workflow-data-pipeline-review.md`.
...
- KB: `.github/kb/teams-notifications/`
...
Apoio:
- `.github/agents/ai-ml/genai-architect.md` (visão de sistema, se o âmbito for maior que CrewAI)
- `.github/agents/domain/dataops-builder.md` (se o foco for DataOps + LangFuse + GCP)
...
### Se o usuário quer criar ou manter agentes (arquivos `.md` em `.github/agents`)
Priorizar:
- `.github/agents/exploration/agent-architect.md`
