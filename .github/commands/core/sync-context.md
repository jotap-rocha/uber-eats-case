---
name: sync-context
description: Sync project context to .github/CURSOR.MD by analyzing codebase patterns and conventions
---

# Sync Context Command

Analyzes codebase and intelligently updates `.github/CURSOR.MD` with current project context.
...
3. **Merges** with existing `.github/CURSOR.MD` content
...
## `.github/CURSOR.MD` template

Generated `.github/CURSOR.MD` follows this structure:
...
```text
1. Read existing `.github/CURSOR.MD`
   │
   ▼
...
6. Validate (dry-run or save)
   │
   ▼
7. Write updated `.github/CURSOR.MD`
```
...
━━━━━━━━━━━━━━━━
`.github/CURSOR.MD` updated successfully
```
...
git diff .github/CURSOR.MD

# Commit with context
git add .github/CURSOR.MD
git commit -m "chore: update .github/CURSOR.MD with latest project structure"
```