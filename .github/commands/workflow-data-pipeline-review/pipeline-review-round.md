...
**Canônico:** `.github/commands/workflow-data-pipeline-review/pipeline-review-round.md`.
...
1. Lê `.github/sdd/data-pipeline-reviews/{RUN_ID}/REVIEW_MANIFEST.yaml`.
...
**`data-pipeline-review-round`** — `.github/agents/workflow-data-pipeline-review/data-pipeline-review-round.md`
