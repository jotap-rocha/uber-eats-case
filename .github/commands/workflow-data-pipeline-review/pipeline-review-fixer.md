...
**Canônico:** `.github/commands/workflow-data-pipeline-review/pipeline-review-fixer.md`.
...
**`data-pipeline-review-fixer`** — `.github/agents/workflow-data-pipeline-review/data-pipeline-review-fixer.md`
