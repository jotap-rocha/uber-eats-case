...
**Canônico:** `.github/commands/workflow-data-pipeline-review/pipeline-review-lane.md`.
...
- Relatório completo em `.github/sdd/data-pipeline-reviews/{RUN_ID}/lanes/{lane_id}.md`.
...
Detalhe do processo: `.github/agents/workflow-data-pipeline-review/data-pipeline-review-lane.md`.
