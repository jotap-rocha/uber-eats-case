...
**Arquivo canônico:** `.github/commands/workflow-data-pipeline-review/workflow-data-pipeline-review.md`.

Este comando é o **roteador** do review. Execute os passos abaixo na ordem, um slash por objetivo.

## Passos

1. **`/pipeline-review-init <RUN_ID>`** — Cria `.github/sdd/data-pipeline-reviews/{RUN_ID}/`, manifest, stubs de lanes e log inicial.  
   Ex.: `/pipeline-review-init pr-1842-pipeline-dim-cliente`

2. **`/pipeline-review-lane <RUN_ID> <lane_id>`** — Uma lane por invocação.  
   Ordem recomendada (ver [`.github/sdd/architecture/WORKFLOW_DATA_PIPELINE_REVIEW_CONTRACTS.yaml`](../../sdd/architecture/WORKFLOW_DATA_PIPELINE_REVIEW_CONTRACTS.yaml)):
   ...
   **Mandatos operacionais:** cruzar findings com [`.github/sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml`](../../sdd/architecture/PIPELINE_MANDATORY_PRACTICES.yaml) (Teams, schema drift, quarentena, sentinela, contrato).
...
Agentes: `.github/agents/workflow-data-pipeline-review/` · Índice: [`README.md`](README.md)
