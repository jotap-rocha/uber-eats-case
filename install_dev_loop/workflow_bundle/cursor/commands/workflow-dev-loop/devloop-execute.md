...
**Canônico:** `.cursor/commands/workflow-dev-loop/devloop-execute.md`
...
1. Lê manifest → `prompt_file` (ex.: `.cursor/dev/tasks/PROMPT_{RUN_ID}.md`)
...
**`devloop-execute`** — `.cursor/agents/workflow-dev-loop/devloop-execute.md`  
Motor: `dev-loop-executor` + [`.cursor/commands/dev/dev.md`](../dev/dev.md)
