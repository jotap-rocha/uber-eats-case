...
## Workflow estruturado (recomendado)

Para RUN com manifest, gate L2/L3 obrigatório e revisão humana do PROMPT antes de executar:

```bash
/workflow-dev-loop
/devloop-init my-feature
/devloop-phase my-feature gate
# … requirements → design → craft → prompt_review
/devloop-execute my-feature
/devloop-phase my-feature reflect
```

Ver [`__TREE__/commands/workflow-dev-loop/`](../commands/workflow-dev-loop/) e [`DEV_LOOP_Guia_Comandos.md`](../../get_started/DEV_LOOP_Guia_Comandos.md).
...
```bash
# Copy template
cp __TREE__/dev/templates/PROMPT_TEMPLATE.md \
   __TREE__/dev/tasks/PROMPT_MY_TASK.md
...
See `__TREE__/dev/docs/AGENT_MATCHING_ENGINE.md` for full algorithm.
...
| File | Purpose |
|------|---------|
| `__TREE__/commands/dev/dev.md` | Command definition |
| `__TREE__/agents/dev/prompt-crafter.md` | PROMPT crafting agent |
| `__TREE__/agents/dev/agentloop-executor.md` | Execution agent |
| `__TREE__/dev/docs/AGENT_MATCHING_ENGINE.md` | Matching Engine algorithm |
| `__TREE__/dev/templates/PROMPT_TEMPLATE.md` | Blank PROMPT template |
| `__TREE__/dev/templates/PROMPT_EXAMPLE_FEATURE.md` | Example: Python utility |
| `__TREE__/dev/templates/PROMPT_EXAMPLE_KB.md` | Example: KB domain |
| `__TREE__/dev/templates/PROGRESS_TEMPLATE.md` | Progress file template |
| `__TREE__/dev/examples/` | Real-world examples from actual feature builds |
