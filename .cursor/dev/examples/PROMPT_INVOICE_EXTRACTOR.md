...
| Metric | Value |
|--------|-------|
| **PROMPT** | `.cursor/dev/tasks/PROMPT_INVOICE_EXTRACTOR.md` |
...
Progress file: `.cursor/dev/progress/PROGRESS_INVOICE_EXTRACTOR.md`
...
*Log generated by AgentLoop Executor v3.0*
