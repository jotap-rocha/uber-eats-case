...
Ver [`.cursor/commands/workflow-dev-loop/`](../commands/workflow-dev-loop/) e [`DEV_LOOP_Guia_Comandos.md`](../../get_started/DEV_LOOP_Guia_Comandos.md).
...
cp .cursor/dev/templates/PROMPT_TEMPLATE.md \
   .cursor/dev/tasks/PROMPT_MY_TASK.md
...
See `.cursor/dev/docs/AGENT_MATCHING_ENGINE.md` for full algorithm.
...
| File | Purpose |
|------|---------|
| `.cursor/commands/dev/dev.md` | Command definition |
| `.cursor/agents/dev/prompt-crafter.md` | PROMPT crafting agent |
| `.cursor/agents/dev/agentloop-executor.md` | Execution agent |
| `.cursor/dev/docs/AGENT_MATCHING_ENGINE.md` | Matching Engine algorithm |
| `.cursor/dev/templates/PROMPT_TEMPLATE.md` | Blank PROMPT template |
| `.cursor/dev/templates/PROMPT_EXAMPLE_FEATURE.md` | Example: Python utility |
| `.cursor/dev/templates/PROMPT_EXAMPLE_KB.md` | Example: KB domain |
| `.cursor/dev/templates/PROGRESS_TEMPLATE.md` | Progress file template |
| `.cursor/dev/examples/` | Real-world examples from actual feature builds |
