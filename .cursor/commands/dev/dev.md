...
✅ PROMPT CREATED
=================
File: .cursor/dev/tasks/PROMPT_REDIS_CACHE.md
Tasks: 6 (🔴2 🟡3 🟢1)
...
| `--list` | List available PROMPTs in `.cursor/dev/tasks/` |
...
# Progress was saved to: .cursor/dev/progress/PROGRESS_REDIS_CACHE.md
...
| Resource | Path |
|----------|------|
| Level 2 Overview | `.cursor/dev/_index.md` |
| Prompt Crafter Agent | `.cursor/agents/dev/prompt-crafter.md` |
| Dev Loop Executor | `.cursor/agents/dev/dev-loop-executor.md` |
| PROMPT Template | `.cursor/dev/templates/PROMPT_TEMPLATE.md` |
| Level 3 (SDD) | `.cursor/sdd/_index.md` |
