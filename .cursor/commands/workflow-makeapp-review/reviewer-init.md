...
name: reviewer-init
description: |
  Inicia execução MakeApp Review: cria RUN em .cursor/sdd/reviews/{RUN_ID}/ com manifest
...
**Canónico:** `.cursor/commands/workflow-makeapp-review/reviewer-init.md`. Atalho: [`../review/reviewer-init.md`](../review/reviewer-init.md) (mesmo `name` no frontmatter).
...
1. Cria `.cursor/sdd/reviews/{RUN_ID}/`
...
Invocar **`makeapp-review-init`** (`.cursor/agents/workflow-makeapp-review/makeapp-review-init.md`).
...
Contrato de lanes: `.cursor/sdd/architecture/WORKFLOW_MAKEAPP_REVIEW_CONTRACTS.yaml`  
Documentação: `.cursor/sdd/reviews/README.md`
