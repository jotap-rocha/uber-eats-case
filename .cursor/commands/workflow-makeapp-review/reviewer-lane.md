...
**Canónico:** `.cursor/commands/workflow-makeapp-review/reviewer-lane.md`. Atalho: [`../review/reviewer-lane.md`](../review/reviewer-lane.md).
...
- Relatório **completo** em `.cursor/sdd/reviews/{RUN_ID}/lanes/{lane_id}.md`
...
Detalhe do processo: `.cursor/agents/workflow-makeapp-review/makeapp-review-lane.md`.

---

## Agente

**`makeapp-review-lane`** — `.cursor/agents/workflow-makeapp-review/makeapp-review-lane.md`

---

## Referências

- Lanes, globs, KB: `.cursor/sdd/architecture/WORKFLOW_MAKEAPP_REVIEW_CONTRACTS.yaml`
- Estado: `.cursor/sdd/reviews/{RUN_ID}/REVIEW_MANIFEST.yaml`
- Sumário consolidado (após `ui_ux`): `.cursor/sdd/reviews/{RUN_ID}/REVIEW_SUMMARY.md`
