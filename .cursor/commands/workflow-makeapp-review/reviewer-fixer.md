...
**Canónico:** `.cursor/commands/workflow-makeapp-review/reviewer-fixer.md`. Atalho: [`../review/reviewer-fixer.md`](../review/reviewer-fixer.md).
...
**`makeapp-review-fixer`** — `.cursor/agents/workflow-makeapp-review/makeapp-review-fixer.md`
