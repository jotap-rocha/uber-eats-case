...
description: |
  Inicia execução Data Pipeline Review: cria RUN em .cursor/sdd/data-pipeline-reviews/{RUN_ID}/
...
**Canônico:** `.cursor/commands/workflow-data-pipeline-review/pipeline-review-init.md`.
...
1. Cria `.cursor/sdd/data-pipeline-reviews/{RUN_ID}/`.
...
Invocar **`data-pipeline-review-init`** (`.cursor/agents/workflow-data-pipeline-review/data-pipeline-review-init.md`).
...
Contrato de lanes: `.cursor/sdd/architecture/WORKFLOW_DATA_PIPELINE_REVIEW_CONTRACTS.yaml`  
Documentação: `.cursor/sdd/data-pipeline-reviews/README.md`
