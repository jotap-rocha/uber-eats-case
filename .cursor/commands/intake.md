...
**Arquivo canônico:** `.cursor/commands/intake.md` (este documento).

**Fonte única de dados:** [`.cursor/sdd/architecture/AGENT_ROUTER.yaml`](../sdd/architecture/AGENT_ROUTER.yaml) — hints, roster, contrato `intake_contract` e regras de síntese.
