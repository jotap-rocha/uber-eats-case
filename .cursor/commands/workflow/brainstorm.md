...
```text
Phase 0: /brainstorm → .cursor/sdd/features/BRAINSTORM_{FEATURE}.md (THIS COMMAND)
...
```markdown
Write(.cursor/sdd/features/BRAINSTORM_{FEATURE}.md)
```
...
| Artifact | Location |
|----------|----------|
| **Brainstorm Document** | `.cursor/sdd/features/BRAINSTORM_{FEATURE}.md` |

**Next Step:** `/define .cursor/sdd/features/BRAINSTORM_{FEATURE}.md`
