...
```bash
/build .cursor/sdd/features/DESIGN_CLOUD_RUN_FUNCTIONS.md
...
Phase 3: /build    → Code + .cursor/sdd/reports/BUILD_REPORT_{FEATURE}.md (THIS COMMAND)
...
```markdown
Write(.cursor/sdd/reports/BUILD_REPORT_{FEATURE}.md)
```
...
| **Build Report** | `.cursor/sdd/reports/BUILD_REPORT_{FEATURE}.md` |

**Next Step:** `/ship .cursor/sdd/features/DEFINE_{FEATURE}.md` (when ready)
...
- Agent: `.cursor/agents/workflow/build-agent.md`
- Template: `.cursor/sdd/templates/BUILD_REPORT_TEMPLATE.md`
- Contracts: `.cursor/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `.cursor/commands/workflow/ship.md`