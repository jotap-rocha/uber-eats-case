...
> Dual AI code review with CodeRabbit + Cursor Code for maximum coverage
...
/review --deep                 # Cursor only (no CodeRabbit)
```
...
| **Cursor** | Architectural review, business logic, GenAI patterns, contextual understanding |
...
IF coderabbit command not found:
  ...
  2. If still fails: Proceed with cursor-only review
...
IF authentication error:
  ...
  2. Proceed with Cursor-only review
...
Cursor only — for thorough analysis:
...
**Process:**
1. Skip CodeRabbit
2. Full Cursor analysis with all capabilities
...
- Agent: `.cursor/agents/code-quality/dual-reviewer.md`
- Config: `.coderabbit.yaml`
- Create PR: `.cursor/commands/workflow/create-pr.md`