...
VALIDAÇÃO
├─ KB: .cursor/kb/{domínio}/_______________
...
|-------------------|-----------------|----------|
| `.cursor/CURSOR.MD` | Sempre recomendado | Tarefa trivial |
| `.cursor/kb/{domínio}/` | Tarefa combina com domínio | Domínio não aplicável |
...
**Processo:**
1. Carregar KB: `.cursor/kb/{domínio}/{arquivo}.md`
...
| Novo domínio KB | Criar `.cursor/kb/{domínio}/` |
