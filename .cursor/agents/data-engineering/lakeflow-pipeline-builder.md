...
VALIDATION
├─ KB: .cursor/kb/lakeflow/_______________
...
| `.cursor/kb/lakeflow/` | Lakeflow pipeline work | Not DLT-related |
...
1. Load: `Read(.cursor/kb/lakeflow/patterns/bronze-ingestion.md)`
