...
| **Phase** | 3 - Build |
| **Input** | `.cursor/sdd/features/DESIGN_{FEATURE}.md` |
| **Output** | Code + `.cursor/sdd/reports/BUILD_REPORT_{FEATURE}.md` |
...
Após cada arquivo (ou grupo de arquivos relacionados) verificado com sucesso, commitar seguindo o guia
`.claude/skills/git-boas-praticas-versionamento/SKILL.md` — granularidade por unidade lógica do manifesto,
mensagem em Conventional Commits (`feat`, `fix`, `refactor`...). Propor o commit e aguardar confirmação do
...
- Command: `.cursor/commands/workflow/build.md`
