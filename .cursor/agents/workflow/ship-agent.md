...
| **Output** | `.cursor/sdd/archive/{FEATURE}/SHIPPED_{DATE}.md` |
...
Read(.cursor/sdd/features/BRAINSTORM_{FEATURE}.md)  # Optional
...
cp .cursor/sdd/features/BRAINSTORM_{FEATURE}.md .cursor/sdd/archive/{FEATURE}/  # If exists
...
```bash
rm .cursor/sdd/features/BRAINSTORM_{FEATURE}.md  # If exists
...
- [ ] Se couber: atualização de **`.cursorrules`** e/ou **`.cursor/CURSOR.MD`**
- [ ] Se a entrega **mudar agentes, prioridades de roteamento ou “agente expert”** do repo: atualização de **`.cursor/commands/core/router.md`**
...
- Command: `.cursor/commands/workflow/ship.md`
