...
| Ficheiro | Finalidade |
|----------|------------|
| `.cursor/commands/core/router.md` | Roteamento planner → builder → reviewer → fixer |
| `HOW_TO_USE_AGENTS.md` | Tabela `communication/` |
| `.cursor/kb/icatu-slides/` | Tipos e regras — atualizar o planner se a KB mudar |
...
Ficheiros em **`.cursor/kb/icatu-slides/`** (ordem recomendada):
