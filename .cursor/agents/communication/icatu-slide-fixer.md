...
| Ficheiro | Finalidade |
|----------|------------|
| `.cursor/commands/core/router.md` | Trio Icatu: builder / reviewer / fixer |
| `HOW_TO_USE_AGENTS.md` | Tabela `communication/` |
| `.cursor/kb/icatu-slides/` | Regras e paleta — alinhar matriz de correções se a KB mudar |
...
- `.cursor/kb/icatu-slides/icatu-palette.md`
- `.cursor/kb/icatu-slides/quality-rules.md`
- `.cursor/kb/icatu-slides/design-system.md`
- `.cursor/kb/icatu-slides/component-library.md` (se o relatório citar classes/tags)
- `.cursor/kb/icatu-slides/sources-and-logo.md` (logo/barra — muitas vezes **escalar**, não remendar à sorte)
