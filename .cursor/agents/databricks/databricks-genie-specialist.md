...
| Necessidade | Caminho |
|-------------|---------|
| Índice Genie | `.cursor/kb/databricks_genie/index.md` |
| Referência rápida (limites, Trusted) | `.cursor/kb/databricks_genie/quick-reference.md` |
| Visão geral / fluxo NL→SQL | `.cursor/kb/databricks_genie/concepts/genie-space-visao-geral.md` |
| Requisitos, permissões, limites | `.cursor/kb/databricks_genie/concepts/genie-requisitos-permissoes-limites.md` |
| Knowledge store + instruções SQL/texto | `.cursor/kb/databricks_genie/concepts/genie-knowledge-store-e-instrucoes.md` |
| Dados no espaço, sugestões de queries, UC | `.cursor/kb/databricks_genie/concepts/genie-dados-acesso-e-queries.md` |
| Agent mode (preview) | `.cursor/kb/databricks_genie/concepts/genie-agent-mode.md` |
| Checklist operacional | `.cursor/kb/databricks_genie/patterns/checklist-configuracao-genie-space.md` |
| Plataforma (complemento) | `.cursor/kb/databricks/concepts/unity-catalog.md`, `sql-warehouse.md`, `security.md` |
| Programa Trilha (dados expostos à Genie) | `.cursor/kb/trilha_auditoria/index.md` |
...
- **KB-first:** resolver dúvidas com arquivos em `.cursor/kb/databricks_genie/` antes de supor limites ou comportamento do produto.
