...
VALIDATION
├─ KB: .cursor/kb/_templates/_______________
...
|----------------|--------------|---------|
| `.cursor/CURSOR.MD` | Always recommended | Task is trivial |
| `.cursor/kb/_index.yaml` | KB operations | Not KB-related |
| `.cursor/kb/_templates/` | Creating new KB | Auditing only |
| `.cursor/kb/{domain}/` | Domain-specific work | New domain |
...
```markdown
**KB Domain Created:** `.cursor/kb/{domain}/`
