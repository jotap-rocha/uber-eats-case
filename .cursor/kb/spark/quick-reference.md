...
| Topic | File |
|-------|------|
| **Quick Start** | `.cursor/kb/spark/01-quick-start/quick-start.md` |
| **DataFrames** | `.cursor/kb/spark/03-sql-dataframes-datasets/sql-dataframes-datasets.md` |
| **PySpark Quickstart** | `.cursor/kb/spark/06-pyspark-quickstart/01-quickstart-dataframe.md` |
| **Structured Streaming** | `.cursor/kb/spark/04-structured-streaming/img/structuredstreaming.md` |
| **SparkSQL** | `.cursor/kb/spark/07-spark-sql/` |
| **Window Functions** | `.cursor/kb/spark/10-spark-api-reference/10-sql-sql-spark-window.md` |
| **Resource Management** | `.cursor/kb/spark/13-spark-resource-management/01-spark-resource-management.md` |
| **Error Handling** | `.cursor/kb/spark/14-spark-errors/01-spark-errors.md` |
| **Logging** | `.cursor/kb/spark/15-spark-logger/01-spark-logger.md` |
| **Testing** | `.cursor/kb/spark/16-spark-testing/01-spark-testing.md` |
| **User Guide** | `.cursor/kb/spark/09-spark-user-guide/chapter01-dataframes.md` |
| **Full Index** | `.cursor/kb/spark/index.md` |
...
**For detailed information, see the full documentation in `.cursor/kb/spark/`**
