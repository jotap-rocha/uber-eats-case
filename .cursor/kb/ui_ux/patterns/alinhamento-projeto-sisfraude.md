...
- `.cursor/kb/sisfraude/` — domínio de casos e sessão multi-empresa  
- `.cursor/kb/frontend/` — Tailwind, shadcn, TypeScript  
- `.cursor/kb/react/` — hooks, estado derivado, providers  
